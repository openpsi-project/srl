...
from .util.path import worldgen_path
from .objs.obj import Obj
from .parser import unparse_dict, update_mujoco_dict
...
class WorldBuilder(Obj):
    ...
    def get_sim(self):
        ...
        self.placements["top"] = {"origin": np.zeros(3), "size": self.world_params.size}
...
class FullVirtualWorldException(Exception):
    ...
    def __init__(self, msg=''):
        Exception.__init__(self,
                           "Virtual world is full of objects. " + "Cannot allocate more of them. " + msg)
