        ...
        if self.scenario in ['quadrant', 'var_quadrant']:
            ...
            if wall1_orientation == 'horizontal':
                ...
                if wall2_orientation == 'left':
                    walls_to_split += [
                        Wall([wall2_splitoff_point, wall1_splitoff_point], [wall2_splitoff_point, 0])
                    ]
                    ...
                    walls_to_split += [
                        Wall([wall2_splitoff_point, self.grid_size - 1],
                ...
                if wall2_orientation == 'left':
                    walls_to_split += [
                        Wall([wall1_splitoff_point, wall2_splitoff_point], [0, wall2_splitoff_point])
                    ]
                    ...
                    walls_to_split += [
                        Wall([self.grid_size - 1, wall2_splitoff_point],
                             [wall1_splitoff_point, wall2_splitoff_point])
                    ]
